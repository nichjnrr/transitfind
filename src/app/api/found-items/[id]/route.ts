// src/app/api/found-items/[id]/route.ts
...
// DELETE /api/found-items/[id] — delete one of the user's own found reports
export async function DELETE(
  ...
  try {
    ...
    const item = await prisma.foundItem.findUnique({ where: { id: params.id } });
    if (!item) {
...
// PATCH /api/found-items/[id] — update status (e.g. mark as CLOSED)
